(function ($s, $slate) {
    $slate.fn._canvas = function () {
        ...
        _self.centerOnNodes = function (_opts) {
            ...
            _self.move({ x: _x, y: _y, isAbsolute: true, dur: opts.dur, easing: 'swingFromTo', callbacks: { after: function () { opts.cb && opts.cb(); } } });
        };
        ...
        _self.move = function (_opts) {
            ...
            console.log("moving with ", opts.dur, _opts.dur);
        ...
        _self.init = function (_options) {
            ...
            imageFolder = opts.imageFolder || "/packages/slatebox/lib/client/images/";
