(function ($s, $n) {
    $n.fn._images = function () {
                ...
                , onOpen: function (container, _ntfy) {
                    ...
                    container.innerHTML = "<div style='width:900px;'>" +
                                            "<div id='embedDivAction' style='float:left;width:260px;'>" +
                                                ...
                                                "<span style='display:none;font-size:20pt;color:#ccc;' id='embedUrlPrefix'>http://</span><input type='text' id='txtSearch' style='width:180px;font-size:14pt;'/>" +
                                                "&nbsp;<button id='btnImageSearch' class='btn btn-success' style='margin-top:-10px;'>go</button>" +
        ...
        function bindResults() {
            ...
            var _template = "<div style='float:left;cursor:pointer;border:1px solid transparent;padding:5px;height:150px;overflow:hidden;' class='searchImage' rel='{url}|{width}|{height}'><div style='width:100px;height:125px;text-align:center;'><img src='{thumb}' title='{title}' alt='{title}' style='width:90px;'/></div><div style='text-align:center;'>{width} x {height}</div></div>";
            var _results = '';
