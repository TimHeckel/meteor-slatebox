    ...
    $n.fn._images = function () {
        ...
        _self.start = function (_options) {
            ...
            options = {
                ...
                , patternUrl: 'https://www.colourlovers.com/api/patterns?keywords={query}&orderCol=score&sortBy=DESC&numResults={rpp}&resultOffset={page}&jsonCallback=?'
                , size: 'Small'
                , isColor: true
                ...
                , onOpen: function (container, _ntfy) {
                    ...
                    container.innerHTML = "<div style='width:900px;'>" +
                                            "<div id='embedDivAction' style='float:left;width:260px;'>" +
                                                "<span style='font-size:20pt;' id='spnEmbedAction'>Search</span><br/>" +
                                                "<span style='display:none;font-size:20pt;color:#ccc;' id='embedUrlPrefix'>http://</span><input type='text' id='txtSearch' class='input-sm' style='margin-bottom:-2px;color:#000;font-size:12pt;'/>" +
                                                "&nbsp;<button id='btnImageSearch' class='btn btn-success btn-sm'>go</button>" +
                                                ...
                                                "</div>" +
                                                "<div style='font-size:12pt;'><label for='radioImage' style='cursor:pointer;'>" +
                                                ...
                                                "</div>" +
                                            "</div>" +
                                            "<div style='float:left;width:30px;visibility:hidden;margin-right:-10px;margin-left:-10px;font-size:40pt;cursor:pointer;color:red;' id='lnkSearchBack' class='imgChanger'> < </div>" +
                                            "<div style='float:left;width:470px;' id='imgResults'></div>" +
                                            "<div style='float:left;width:30px;visibility:hidden;margin-right:-10px;margin-left:-10px;font-size:40pt;cursor:pointer;color:red;' id='lnkSearchForward' class='imgChanger'> > </div>" +
                                        "</div>";
