    ...
    $n.fn._relationships = function () {
            ...
            if (_self._.options.allowMenu) {
                ...
                c.line.mouseover(function (e) {
                    if (_self._.slate.options.enabled) {
                        ...
                        //var _pos = { x: Math.abs(_par.x - _child.x), y: Math.abs(_par.y - _child.y)/2 + Math.min(_par.y, _child.y) };
        
                        _self._.lineOptions.show(e, c);
                        //_self._.menu.show(e);
                        /*
                        console.log("line wired");
        ...
        function hitTest(mp) {
            ...
            $s.each(_self._.slate.nodes.allNodes, function () {
                if (this.options.id !== _self._.slate.tempNodeId && this.options.id !== _self._.options.id && this.options.allowContext && this.options.allowResize) {
