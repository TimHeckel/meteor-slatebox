                ...
                , onOpen: function (container, _ntfy) {
                    ...
                    container.innerHTML = "<div style='width:900px;'>" +
                                            "<div id='linkForm'><div id='provideUrlPlaceholder' style='height:75px;width:900px;'>" +
                                                "<span style='font-size:16pt;' id='spnEmbedAction'>Provide an external link (will always open in a new window)</span><br/>" +
                                                "<span style='font-size:16pt;color:#ccc;' id='embedUrlPrefix'>http://</span>" +
                                                "<input type='text' id='txtUrl' style='width:450px;font-size:16pt;color:#000'/>" +
                                                "&nbsp;<button id='btnApply' class='btn btn-primary'>go</button>&nbsp;<button id='btnRemove' class='btn btn-danger' style='visibility:hidden;'>remove</button>" +
                                            "</div>" +
        ...
        _self.processEvent = function () {
            switch (_self._.options.link.type) {
                case "externalUrl":
                    ...
                    window.setTimeout(function() {
                        console.log("set ", _self._.options.link.data);
