(function ($s, $n) {
    $n.fn._resize = function () {
        ...
        var _minWidth = 10, _minHeight = 10, _dragAllowed = false, _origWidth, _origHeight, _isResizing = false;
        var start = function () {
            _isResizing = true;
            var s = this;
            ...
            window.setTimeout(function() {
                if (_isResizing) up(); //they should be done in five seconds or else this will fire
            }, 5000);
        },
        move = function (dx, dy) {
