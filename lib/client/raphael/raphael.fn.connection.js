Raphael.fn.connection = function (_options) {
    ...
    var details = calcPath()
        , _attr = { "arrow-end": "classic", path: details.path, stroke: options.lineColor, fill: "none", "stroke-width": options.lineWidth, "fill-opacity": options.lineOpacity, opacity: options.lineOpacity };
