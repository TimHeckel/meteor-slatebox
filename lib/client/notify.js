...
(function ($s, $e) {
    var n = function () {
        ...
        _self.message = function (_options) {
            ...
            function buildBar() {
                var _inside = "<div style='min-width:950px;'><div style='text-align:left;padding: 10px;float:left;width:84%;' id='notifyBarMessage_" + uid + "'>" + options.msg + "</div><div style='float:right;margin-top:6px;padding-right:2px;width:4%;'><a href='javascript:' class='lnkCloseMessage' id='lnkCloseMessage_" + uid + "'>X</a></div></div>";
